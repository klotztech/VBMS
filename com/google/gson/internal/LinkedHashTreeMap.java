...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C01861();
    ...
    static class C01861 implements Comparator<Comparable> {
        C01861() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03041 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03041() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C03051 extends LinkedTreeMapIterator<K> {
            C03051() {
                super();
            }
