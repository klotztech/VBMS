...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C01871();
    ...
    static class C01871 implements Comparator<Comparable> {
        C01871() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03061 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03061() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C03071 extends LinkedTreeMapIterator<K> {
            C03071() {
                super();
            }
