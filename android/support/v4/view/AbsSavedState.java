...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C02472());
    ...
    static class C02472 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02472() {
        }
