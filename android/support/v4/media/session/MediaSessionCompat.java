...
public class MediaSessionCompat {
    ...
    class C02391 extends Callback {
        C02391() {
        }
    }

    class C02402 extends Callback {
        C02402() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02411();
        ...
        class C02411 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02411() {
            }
        ...
        class C03482 implements Callback {
            C03482() {
            }
