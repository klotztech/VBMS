...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03521();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03532();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02703();

    class C02703 implements ViewPropertyAnimatorUpdateListener {
        C02703() {
        }
    ...
    class C03521 extends ViewPropertyAnimatorListenerAdapter {
        C03521() {
        }
