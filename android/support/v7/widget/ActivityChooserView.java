...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01584 extends DataSetObserver {
        C01584() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C01561();
        this.mOnGlobalLayoutListener = new C01572();
        ...
        this.mAdapter.registerDataSetObserver(new C01584());
