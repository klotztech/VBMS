...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01631 implements OnAttachStateChangeListener {
        C01631() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01631());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01642());
    }
