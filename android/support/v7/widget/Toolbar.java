...
public class Toolbar extends ViewGroup {
    ...
    class C02801 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02801() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02811());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C02811 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02811() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02801();
